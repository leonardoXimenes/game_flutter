...
class PortaAmarelaCima extends GameDecoration with ObjectCollision, Lighting {
  Sprite? portaC, portaCAberta;

  PortaAmarelaCima(Vector2 position)
      : super.withSprite(
...
//---------------------------------------------------------------------
class PortaAmarelaBaixo extends GameDecoration with ObjectCollision, Lighting {
  Sprite? portaB, portaBAberta;

  PortaAmarelaBaixo(Vector2 position)
      : super.withSprite(
